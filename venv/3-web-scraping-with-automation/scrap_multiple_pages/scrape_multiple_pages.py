...
for page_number in range(1,4):
    ...
    # define the url
    url = "https://market.feedbooks.com/top/top_monthly?carousel_id=25&languages=en&release_date=recent_month&sale_status=on_sale&subsets=traditional"+str(page_number)
